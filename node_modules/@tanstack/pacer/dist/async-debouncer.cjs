...
var AsyncDebouncer = class {
	...
	constructor(fn, initialOptions) {
		this.fn = fn;
		this.store = new _tanstack_store.Store(getDefaultAsyncDebouncerState());
		...
		if (this.key) require_event_client.pacerEventClient.on("d-AsyncDebouncer", (event) => {
	...
	#setState = (newState) => {
		...
		require_event_client.emitChange("AsyncDebouncer", this);
	};
	/**
