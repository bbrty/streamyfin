...
//#region src/async-throttler.d.ts
interface AsyncThrottlerState<TFn extends AnyAsyncFunction> {
  /**
 ...
 */
interface AsyncThrottlerOptions<TFn extends AnyAsyncFunction> {
  /**
   ...
   */
  onError?: (error: Error, args: Parameters<TFn>, asyncThrottler: AsyncThrottler<TFn>) => void;
  /**
 ...
 */
declare function asyncThrottlerOptions<TFn extends AnyAsyncFunction = AnyAsyncFunction, TOptions extends Partial<AsyncThrottlerOptions<TFn>> = Partial<AsyncThrottlerOptions<TFn>>>(options: TOptions): TOptions;
/**
 ...
 * ```
 */
declare class AsyncThrottler<TFn extends AnyAsyncFunction> {
  #private;
  fn: TFn;
 ...
 * ```
 */
declare function asyncThrottle<TFn extends AnyAsyncFunction>(fn: TFn, initialOptions: AsyncThrottlerOptions<TFn>): (...args: Parameters<TFn>) => Promise<ReturnType<TFn> | undefined>;
//#endregion
export { AsyncThrottler, AsyncThrottlerOptions, AsyncThrottlerState, asyncThrottle, asyncThrottlerOptions };
//# sourceMappingURL=async-throttler.d.cts.map