...
var AsyncThrottler = class {
	...
	constructor(fn, initialOptions) {
		this.fn = fn;
		this.store = new _tanstack_store.Store(getDefaultAsyncThrottlerState());
		...
		if (this.key) require_event_client.pacerEventClient.on("d-AsyncThrottler", (event) => {
	...
	#setState = (newState) => {
		...
		require_event_client.emitChange("AsyncThrottler", this);
	};
	/**
