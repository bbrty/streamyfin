...
var AsyncRetryer = class {
	...
	*/
	constructor(fn, initialOptions = {}) {
		this.fn = fn;
		this.store = new _tanstack_store.Store(getDefaultAsyncRetryerState());
		...
		if (this.key) require_event_client.pacerEventClient.on("d-AsyncRetryer", (event) => {
	...
	#setState = (newState) => {
		...
		require_event_client.emitChange("AsyncRetryer", this);
	};
	#getEnabled = () => {
		return !!require_utils.parseFunctionOrValue(this.options.enabled, this);
	};
	#getMaxAttempts = () => {
		return require_utils.parseFunctionOrValue(this.options.maxAttempts, this);
	};
	#getBaseWait = () => {
		return require_utils.parseFunctionOrValue(this.options.baseWait, this);
	};
...
//#endregion
exports.AsyncRetryer = AsyncRetryer;
exports.asyncRetry = asyncRetry;
exports.asyncRetryerOptions = asyncRetryerOptions;
//# sourceMappingURL=async-retryer.cjs.map